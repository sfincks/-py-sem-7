...
glasnie = ["а", "у"]   # Нужно просто дополнять список гласных, для более точного отбора
print("Введите кричалку")
vinni_battlecry = list(input())
print(vinni_battlecry)
count =len(list(filter(lambda x: x in glasnie , vinni_battlecry)))
print (count)
